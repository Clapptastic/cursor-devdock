...
import { CustomerSurveySDK } from '../../src';
import { QuestionType, SurveyStatus } from '../../src/models/types';

describe('CustomerSurveySDK Integration', () => {
  let sdk: CustomerSurveySDK;
  ...
  describe('AI features', () => {
    ...
    it('should get survey recommendation based on goal', async () => {
      ...
      const result = await sdk.ai.recommendSurvey(
        recommendationRequest.goal,
        recommendationRequest.industry
      );
