...
describe('CustomerSurveySDK', () => {
    ...
    beforeEach(() => {
        ...
        sdk = new index_1.CustomerSurveySDK({
    ...
    describe('constructor', () => {
        it('should create an instance', () => {
            expect(sdk).toBeInstanceOf(index_1.CustomerSurveySDK);
        });
        it('should throw if apiUrl is not provided', () => {
            expect(() => new index_1.CustomerSurveySDK({})).toThrow('API URL is required');
        });
    });
    ...
    describe('Survey API', () => {
        ...
        it('should create a new survey', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3000/surveys', expect.objectContaining({
                method: 'POST',
    ...
    describe('Response API', () => {
        ...
        it('should submit response', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3000/responses', expect.objectContaining({
                method: 'POST',
    ...
    describe('AI API', () => {
        it('should analyze text', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3000/ai/analyze/text', expect.objectContaining({
                method: 'POST',
        ...
        it('should get insights from responses', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3000/ai/insights', expect.objectContaining({
                method: 'POST',
