 ...
 * All question types
 */
export type QuestionUnion = TextQuestion | SingleChoiceQuestion | MultipleChoiceQuestion | RatingQuestion | ScaleQuestion;
/**
 * Survey status
 */
 ...
 * All answer types
 */
export type Answer = TextAnswer | SingleChoiceAnswer | MultipleChoiceAnswer | RatingAnswer | ScaleAnswer;
/**
 * Survey response
 */
