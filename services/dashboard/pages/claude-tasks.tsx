...
import { getTasks, submitTask, analyzeTaskComplexity, getNextTask, generateSubtasks, clearSubtasks } from '../lib/api';
...
const ClaudeTasks = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* API Key Modal */}
      <div className={`fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-50 ${showApiKey ? '' : 'hidden'}`}>
